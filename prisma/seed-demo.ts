...
/** Optional catalog used only when SEED_DEMO=true. Not run on Railway by default. */
export const DEMO_IDS = {
  branches: ["branch_herzliya", "branch_telaviv"],
  suppliers: ["sup_tnuva", "sup_strauss", "sup_sharon_veg", "sup_shuk"],
  products: [
    "prd_milk",
    "prd_cheese",
    "prd_cream",
  ...
  orders: ["ord_open_veg", "ord_pending_tnuva"],
  receipts: ["rcpt_pending_tnuva"],
  photos: [
    "photo_pending_tnuva",
    "photo_electricity",
    "photo_kitchen_wages",
  ...
  recurring: ["rec_rent", "rec_turnover"],
  files: [
    "demo-tnuva-invoice.svg",
    "demo-electricity.svg",
...
export async function seedDemo(prisma: PrismaClient) {
  ...
  console.log("Vivac'e optional demo catalog is ready (SEED_DEMO=true).");
}
